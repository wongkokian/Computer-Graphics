...
const char blockTexFile[] = "images/block.jpg";
const char jackTexFile[] = "images/jack.jpg";
...
void MakeReflectionImage( void )
{
    ...
    glLoadIdentity();
    gluLookAt( eyePos[0], eyePos[1], TABLETOP_Z * 2 - eyePos[2],
...
// This texture object is for storing the reflection image read from the color buffer.
    ...
    // This texture object is for the block texture map.

    glGenTextures( 1, &blockTexObj );
    glBindTexture( GL_TEXTURE_2D, blockTexObj );
    glTexParameteri( GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR );
    glTexParameteri( GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR_MIPMAP_LINEAR );

    if ( ReadImageFile( blockTexFile, &imageData,
        &imageWidth, &imageHeight, &numComponents ) == 0 ) exit( 1 );
    ...
    // This texture object is for the jack o'lantern texture map.

    glGenTextures( 1, &jackTexObj );
    glBindTexture( GL_TEXTURE_2D, jackTexObj );
    glTexParameteri( GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR );
    glTexParameteri( GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR_MIPMAP_LINEAR );

    if ( ReadImageFile( jackTexFile, &imageData,
        &imageWidth, &imageHeight, &numComponents ) == 0 ) exit( 1 );
...
/////////////////////////////////////////////////////////////////////////////
// Draw the texture-mapped block.
/////////////////////////////////////////////////////////////////////////////

void DrawBlock( void )
{
    double size = 1.0;
    double BLOCK_WIDTH = size;
    double BLOCK_HALF_WIDTH = BLOCK_WIDTH / 2;
    ...
    glPushMatrix();
    glTranslated( 0.6, -0.3, TABLETOP_Z );
    glRotated( 30, 0.0, 0.0, 1.0 );
    glScaled( 0.25, 0.25, 0.25 );

    // In +y direction,
    glNormal3f( 0.0, 1.0, 0.0 ); // Normal vector.
    SubdivideAndDrawQuad( 24, 24,  0.5, (1.0 / 3.0), BLOCK_HALF_WIDTH, BLOCK_HALF_WIDTH, 0,
                                   0.75, (1.0 / 3.0), -BLOCK_HALF_WIDTH, BLOCK_HALF_WIDTH, 0,
                                   0.75, (2.0 / 3.0), -BLOCK_HALF_WIDTH, BLOCK_HALF_WIDTH, BLOCK_WIDTH,
                                   0.5, (2.0 / 3.0), BLOCK_HALF_WIDTH, BLOCK_HALF_WIDTH, BLOCK_WIDTH );
    // In -y direction,
    glNormal3f( 0.0, -1.0, 0.0 ); // Normal vector.
    SubdivideAndDrawQuad( 24, 24,  0.0, (1.0 / 3.0), -BLOCK_HALF_WIDTH, -BLOCK_HALF_WIDTH, 0,
                                   0.25, (1.0 / 3.0), BLOCK_HALF_WIDTH, -BLOCK_HALF_WIDTH, 0,
                                   0.25, (2.0 / 3.0), BLOCK_HALF_WIDTH, -BLOCK_HALF_WIDTH, BLOCK_WIDTH,
                                   0.0, (2.0 / 3.0), -BLOCK_HALF_WIDTH, -BLOCK_HALF_WIDTH, BLOCK_WIDTH );
    // In +x direction,
    glNormal3f( 1.0, 0.0, 0.0 ); // Normal vector.
    SubdivideAndDrawQuad( 24, 24,  0.25, (1.0 / 3.0), BLOCK_HALF_WIDTH, -BLOCK_HALF_WIDTH, 0,
                                   0.5, (1.0 / 3.0), BLOCK_HALF_WIDTH, BLOCK_HALF_WIDTH, 0,
                                   0.5, (2.0 / 3.0), BLOCK_HALF_WIDTH, BLOCK_HALF_WIDTH, BLOCK_WIDTH,
                                   0.25, (2.0 / 3.0), BLOCK_HALF_WIDTH, -BLOCK_HALF_WIDTH, BLOCK_WIDTH );
    // In -x direction,
    glNormal3f( -1.0, 0.0, 0.0 ); // Normal vector.
    SubdivideAndDrawQuad( 24, 24,  0.75, (1.0 / 3.0), -BLOCK_HALF_WIDTH, BLOCK_HALF_WIDTH, 0,
                                   1.0, (1.0 / 3.0), -BLOCK_HALF_WIDTH, -BLOCK_HALF_WIDTH, 0,
                                   1.0, (2.0 / 3.0), -BLOCK_HALF_WIDTH, -BLOCK_HALF_WIDTH, BLOCK_WIDTH,
                                   0.75, (2.0 / 3.0), -BLOCK_HALF_WIDTH, BLOCK_HALF_WIDTH, BLOCK_WIDTH );
    // In +z direction,
    glNormal3f( 0.0, 0.0, 1.0 ); // Normal vector.
    SubdivideAndDrawQuad( 24, 24,  0.25, (2.0 / 3.0), BLOCK_HALF_WIDTH, -BLOCK_HALF_WIDTH, BLOCK_WIDTH,
                                   0.5, (2.0 / 3.0), BLOCK_HALF_WIDTH, BLOCK_HALF_WIDTH, BLOCK_WIDTH,
                                   0.5, 1.0, -BLOCK_HALF_WIDTH, BLOCK_HALF_WIDTH, BLOCK_WIDTH,
                                   0.25, 1.0, -BLOCK_HALF_WIDTH, -BLOCK_HALF_WIDTH, BLOCK_WIDTH );
    // In -z direction,
    glNormal3f( 0.0, 0.0, -1.0 ); // Normal vector.
    SubdivideAndDrawQuad( 24, 24,  0.25, 0.0, -BLOCK_HALF_WIDTH, -BLOCK_HALF_WIDTH, 0,
                                   0.5, 0.0, -BLOCK_HALF_WIDTH, BLOCK_HALF_WIDTH, 0,
                                   0.5, (1.0 / 3.0), BLOCK_HALF_WIDTH, BLOCK_HALF_WIDTH, 0,
                                   0.25, (1.0 / 3.0), BLOCK_HALF_WIDTH, -BLOCK_HALF_WIDTH, 0 );
...
/////////////////////////////////////////////////////////////////////////////
// Draw the texture-mapped jack o'lantern.
/////////////////////////////////////////////////////////////////////////////

void DrawJack( void )
{
    double size = 1.0;
    double JACK_WIDTH = size;
    double JACK_HALF_WIDTH = JACK_WIDTH / 2;
    ...
    glPushMatrix();
    glTranslated( 0.6, -0.3, size * 0.3 + TABLETOP_Z );
    glRotated( 30, 0.0, 0.0, 1.0 );
    glScaled( 0.2, 0.2, 0.2 );

    // In +y direction,
    glNormal3f( 0.0, 1.0, 0.0 ); // Normal vector.
    SubdivideAndDrawQuad( 24, 24,  (1.0 / 3.0), 0.0, JACK_HALF_WIDTH, JACK_HALF_WIDTH, 0,
                                   (2.0 / 3.0), 0.0, -JACK_HALF_WIDTH, JACK_HALF_WIDTH, 0,
                                   (2.0 / 3.0), 1.0, -JACK_HALF_WIDTH, JACK_HALF_WIDTH, JACK_WIDTH,
                                   (1.0 / 3.0), 1.0, JACK_HALF_WIDTH, JACK_HALF_WIDTH, JACK_WIDTH );
    // In -y direction,
    glNormal3f( 0.0, -1.0, 0.0 ); // Normal vector.
    SubdivideAndDrawQuad( 24, 24,  (1.0 / 3.0), 0.0, -JACK_HALF_WIDTH, -JACK_HALF_WIDTH, 0,
                                   (2.0 / 3.0), 0.0, JACK_HALF_WIDTH, -JACK_HALF_WIDTH, 0,
    ...
    // In +x direction,
    glNormal3f( 1.0, 0.0, 0.0 ); // Normal vector.
    SubdivideAndDrawQuad( 24, 24,  0.0, 0.0, JACK_HALF_WIDTH, -JACK_HALF_WIDTH, 0,
                                   (1.0 / 3.0), 0.0, JACK_HALF_WIDTH, JACK_HALF_WIDTH, 0,
                                   (1.0 / 3.0), 1.0, JACK_HALF_WIDTH, JACK_HALF_WIDTH, JACK_WIDTH,
                                   0.0, 1.0, JACK_HALF_WIDTH, -JACK_HALF_WIDTH, JACK_WIDTH );
    // In -x direction,
    glNormal3f( -1.0, 0.0, 0.0 ); // Normal vector.
    SubdivideAndDrawQuad( 24, 24,  (1.0 / 3.0), 0.0, -JACK_HALF_WIDTH, JACK_HALF_WIDTH, 0,
                                   (2.0 / 3.0), 0.0, -JACK_HALF_WIDTH, -JACK_HALF_WIDTH, 0,
    ...
    // In +z direction,
    glNormal3f( 0.0, 0.0, 1.0 ); // Normal vector.
    SubdivideAndDrawQuad( 24, 24,  (2.0 / 3.0), 0.0, JACK_HALF_WIDTH, -JACK_HALF_WIDTH, JACK_WIDTH,
                                   1.0, 0.0, JACK_HALF_WIDTH, JACK_HALF_WIDTH, JACK_WIDTH,
                                   1.0, 1.0, -JACK_HALF_WIDTH, JACK_HALF_WIDTH, JACK_WIDTH,
                                   (2.0 / 3.0), 1.0, -JACK_HALF_WIDTH, -JACK_HALF_WIDTH, JACK_WIDTH );
    // In -z direction,
    glNormal3f( 0.0, 0.0, -1.0 ); // Normal vector.
    SubdivideAndDrawQuad( 24, 24,  (2.0 / 3.0), 0.0, -JACK_HALF_WIDTH, -JACK_HALF_WIDTH, 0,
                                   1.0, 0.0, -JACK_HALF_WIDTH, JACK_HALF_WIDTH, 0,
                                   1.0, 1.0, JACK_HALF_WIDTH, JACK_HALF_WIDTH, 0,
                                   (2.0 / 3.0), 1.0, JACK_HALF_WIDTH, -JACK_HALF_WIDTH, 0 );
